...
class GPT2Attention(nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None, value_zeroing_index=None):
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if output_context_mixings is not None: 
                if output_context_mixings.output_attention:
                    all_self_attentions = all_self_attentions + (outputs[2].mean(dim=1),)
        ...
        return BaseModelOutputWithPastAndCrossAttentions(
            ...
            context_mixings={'attention': all_self_attentions, 'value_zeroing': all_value_zeroings},
        )
